...
'auto-our-story-082': {
  ...
  zh:"在大型预订平台接待客人多年后，我们为喜欢更个性化和透明预订方式的客人创建了直接预订体验。<strong>MiaCasa的官网直接预订</strong>让客人可以更个性化、更透明、更超值地预订住宿。"
},
...
'auto-our-story-083': {
  ...
  zh:"<strong>直接预订的客人享受同样值得信赖的MiaCasa体验</strong>，价格更优，并获得房东的直接支持。"
},
...
'blog-oq-li1': {
  en: '<strong>Hàng Bạc</strong> was known for silver workshops',
  vn: '<strong>Hàng Bạc</strong> nổi tiếng với nghề bạc',
  zh: '<strong>银街（Hàng Bạc）</strong>以银器工艺闻名'
},
'blog-oq-li2': {
  en: '<strong>Hàng Gai</strong> became associated with silk and textiles',
  vn: '<strong>Hàng Gai</strong> nổi tiếng với lụa và thủ công mỹ nghệ',
  zh: '<strong>丝绸街（Hàng Gai）</strong>以丝绸和纺织品闻名'
},
'blog-oq-li3': {
  en: '<strong>Hàng Mã</strong> is famous for colorful decorations, lanterns, festival items and seasonal displays',
  vn: '<strong>Hàng Mã</strong> nổi tiếng với đồ trang trí, đèn lồng, đồ lễ và đồ theo mùa đầy màu sắc',
  zh: '<strong>纸扎街（Hàng Mã）</strong>以彩色装饰品、灯笼、节日用品和季节性展示闻名'
},
'blog-oq-p10': {
...
'blog-oq-info-1': {
  en: '<strong>Stay inside the Old Quarter if you:</strong> want nightlife and constant activity, prefer walking everywhere, enjoy energy and noise, want maximum convenience.',
  vn: '<strong>Ở trong Phố Cổ nếu bạn:</strong> muốn cuộc sống về đêm và hoạt động liên tục, thích đi bộ khắp nơi, thích năng lượng và sự ồn ào, muốn sự tiện lợi tối đa.',
  zh: '<strong>如果你符合以下情况，请住在老城区内：</strong>想要夜生活和持续的活动，喜欢步行到处走走，享受活力和喧嚣，想要最大的便利。'
},
'blog-oq-info-2': {
  en: '<strong>Stay just outside if you:</strong> want better sleep, enjoy quieter cafés and local neighborhoods, still want easy access to the Old Quarter.',
  vn: '<strong>Ở bên ngoài một chút nếu bạn:</strong> muốn ngủ ngon hơn, thích quán cà phê yên tĩnh và khu phố địa phương, vẫn muốn dễ dàng tiếp cận Phố Cổ.',
  zh: '<strong>如果你符合以下情况，请住在稍微外面一点：</strong>想要更好的睡眠，喜欢安静的咖啡馆和本地社区，仍然希望方便前往老城区。'
},
'blog-oq-p27': {
