...
// What is MiaCasa?
'about-what-title': { en: 'What Is MiaCasa Hanoi?', vn: 'MiaCasa Hà Nội Là Gì?', zh: '什么是MiaCasa河内？' },
...
// [HTML] - contains <strong> tags → use data-th
'about-what-p2': {
  en: "We're also listed on <strong>Airbnb</strong> and <strong>Booking.com</strong>, where guests have rated us 9.3 and awarded us Superhost status. But when you book directly through our website, you get better rates, more flexibility, and direct communication with the people who actually host you.",
  vn: 'Chúng tôi cũng có mặt trên <strong>Airbnb</strong> và <strong>Booking.com</strong>, nơi khách đã đánh giá chúng tôi 9.3 và trao tặng danh hiệu Superhost. Nhưng khi bạn đặt phòng trực tiếp qua trang web của chúng tôi, bạn sẽ có giá tốt hơn, linh hoạt hơn và giao tiếp trực tiếp với những người thực sự tiếp đón bạn.',
  zh: '我们也在<strong>Airbnb</strong>和<strong>Booking.com</strong>上，客人们给我们打了9.3分并授予我们超赞房东身份。但当您通过我们的网站直接预订时，您可以获得更好的价格、更多的灵活性，并与真正接待您的人直接沟通。'
},
// [HTML] - contains <strong> tags → use data-th
'about-what-p3': {
...
'about-faq-q1': { en: 'What is MiaCasa Hanoi?', vn: 'MiaCasa Hà Nội là gì?', zh: '什么是MiaCasa河内？' },
...
'about-faq-a3': { en: 'Yes, you can find MiaCasa on Airbnb and Booking.com. However, booking directly through our website offers better rates, flexible payment options, and direct communication with hosts.', vn: 'Có, bạn có thể tìm thấy MiaCasa trên Airbnb và Booking.com. Tuy nhiên, đặt phòng trực tiếp qua trang web của chúng tôi mang lại giá tốt hơn, tùy chọn thanh toán linh hoạt và giao tiếp trực tiếp với chủ nhà.', zh: '是的，您可以在Airbnb和Booking.com上找到MiaCasa。但是，通过我们的网站直接预订可以获得更好的价格、灵活的支付选项以及与房东的直接沟通。' },
