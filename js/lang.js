...
// English
'returning-tag': 'Returning Guests',
'returning-title': 'Manage your <em>existing booking</em>',
'invoice-icon-label': 'Invoice',
'cancel-icon-label': 'Cancel',
'review-hanoi': '⭐ MiaCasa Hanoi',
'review-oq': '⭐ MiaCasa Old Quarter',

// Vietnamese (vn)
'returning-tag': 'Khách quay lại',
'returning-title': 'Quản lý đặt phòng hiện tại của bạn',
'invoice-icon-label': 'Hóa đơn',
'cancel-icon-label': 'Hủy',
'review-hanoi': '⭐ MiaCasa Hà Nội',
'review-oq': '⭐ MiaCasa Phố Cổ',

// Chinese (zh)
'returning-tag': '回访客人',
'returning-title': '管理您现有的预订',
'invoice-icon-label': '发票',
'cancel-icon-label': '取消',
'review-hanoi': '⭐ MiaCasa 河内',
'review-oq': '⭐ MiaCasa 老城区',

// In your translations object:

// English
'review-modal-title': 'Verify Your Stay',
'review-modal-sub': 'Please enter your Booking ID to verify you\'re a guest',
'review-booking-label': 'Booking ID',
'review-help': 'Your Booking ID is in your confirmation email',
'review-property-label': 'Which property did you stay at?',
'review-select-property': 'Select a property',
'review-hanoi-option': 'MiaCasa Hanoi',
'review-oq-option': 'MiaCasa Old Quarter',
'review-submit-btn': 'Continue to Review →',
'review-note': 'Don\'t have your Booking ID? Contact us and we\'ll help.',
'review-contact-link': 'Contact us',

// Vietnamese (vn)
'review-modal-title': 'Xác minh đặt phòng của bạn',
'review-modal-sub': 'Vui lòng nhập Mã đặt phòng để xác minh bạn là khách',
'review-booking-label': 'Mã đặt phòng',
'review-help': 'Mã đặt phòng có trong email xác nhận của bạn',
'review-property-label': 'Bạn đã ở tại cơ sở nào?',
'review-select-property': 'Chọn cơ sở',
'review-hanoi-option': 'MiaCasa Hà Nội',
'review-oq-option': 'MiaCasa Phố Cổ',
'review-submit-btn': 'Tiếp tục đánh giá →',
'review-note': 'Không có Mã đặt phòng? Liên hệ với chúng tôi để được giúp đỡ.',
'review-contact-link': 'Liên hệ',

// Chinese (zh)
'review-modal-title': '验证您的住宿',
'review-modal-sub': '请输入您的预订ID以验证您是住客',
'review-booking-label': '预订ID',
'review-help': '您的预订ID在确认邮件中',
'review-property-label': '您入住的是哪个物业？',
'review-select-property': '选择物业',
'review-hanoi-option': 'MiaCasa 河内',
'review-oq-option': 'MiaCasa 老城区',
'review-submit-btn': '继续评价 →',
'review-note': '没有预订ID？联系我们获取帮助。',
'review-contact-link': '联系我们',

// In your translations object, add:

// English
'returning-sub': 'Manage your existing booking',
'review-icon-label': 'Review',
'review-link': 'Write a review →',
'review-text': 'Share your experience with others',

// Vietnamese (vn)
'returning-sub': 'Quản lý đặt phòng hiện tại của bạn',
'review-icon-label': 'Đánh giá',
'review-link': 'Viết đánh giá →',
'review-text': 'Chia sẻ trải nghiệm của bạn với mọi người',

// Chinese (zh)
'returning-sub': '管理您现有的预订',
'review-icon-label': '评论',
'review-link': '发表评论 →',
'review-text': '与他人分享您的体验',
