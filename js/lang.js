...
/* ── SUBSCRIPTION GDPR ── */
'subscribe-gdpr': {
  en: 'I agree to receive email updates. Unsubscribe anytime. We use Brevo as our marketing platform. Your data will be processed in accordance with <a href="https://www.brevo.com/legal/privacypolicy/" target="_blank" rel="noopener" class="privacy-link">Brevo\'s Privacy Policy</a>.',
  vn: 'Tôi đồng ý nhận cập nhật qua email. Hủy đăng ký bất kỳ lúc nào. Chúng tôi sử dụng Brevo làm nền tảng tiếp thị. Dữ liệu của bạn sẽ được xử lý theo <a href="https://www.brevo.com/legal/privacypolicy/" target="_blank" rel="noopener" class="privacy-link">Chính sách bảo mật của Brevo</a>.',
  zh: '我同意接收电子邮件更新。随时取消订阅。我们使用 Brevo 作为我们的营销平台。您的数据将按照 <a href="https://www.brevo.com/legal/privacypolicy/" target="_blank" rel="noopener" class="privacy-link">Brevo 的隐私政策</a> 进行处理。'
},
...
'cafes-meta': {en:"📅 May 1, 2026 · ☕ 8 min read", vn:"📅 1 Tháng 5, 2026 · ☕ Đọc 8 phút", zh:"📅 2026年5月1日 · ☕ 阅读约8分钟"},
...
'auto-our-story-084': {
  en: 'Guests are always welcome to read our Google, Booking.com, Agoda and Airbnb reviews before deciding to book directly.',
  vn: 'Khách luôn được chào đón để đọc đánh giá của chúng tôi trên Google, Booking.com, Agoda và Airbnb trước khi quyết định đặt phòng trực tiếp.',
  zh: '我们始终欢迎客人在决定直接预订之前，阅读我们在 Google、Booking.com、Agoda 和 Airbnb 上的评价。'
},
...
'story-p1-line5': {
  en: 'That simple idea became MiaCasa.',
  vn: 'Ý tưởng đơn giản đó đã trở thành MiaCasa.',
  zh: '那个简单的想法变成了 MiaCasa。'
},
'story-quote': {
  en: 'Not a hotel. Not just a listing. A home.',
  vn: 'Không phải khách sạn. Không chỉ là một chỗ ở. Mà là một ngôi nhà.',
...
// About MiaCasa Page Translations
...
// What is MiaCasa?
'about-what-title': { en: 'What Is MiaCasa?', vn: 'MiaCasa Là Gì?', zh: '什么是MiaCasa？' },
// [HTML] - contains <strong> tags → use data-th
'about-what-p1': { 
  en: '<strong>MiaCasa is a boutique homestay in Hanoi</strong> — not a large hotel chain, not a faceless rental. We are local hosts who live in the city and personally manage two distinct stays in different parts of Hanoi.',
  vn: '<strong>MiaCasa là một homestay boutique tại Hà Nội</strong> — không phải chuỗi khách sạn lớn, không phải một căn hộ cho thuê vô danh. Chúng tôi là những chủ nhà địa phương sống trong thành phố và trực tiếp quản lý hai chỗ ở khác nhau ở các khu vực khác nhau của Hà Nội.',
  zh: '<strong>MiaCasa是河内的一家精品寄宿家庭</strong> — 不是大型连锁酒店，也不是无名的出租房。我们是居住在这座城市的当地房东，亲自管理河内不同地区的两处不同的住宿。'
},
// [HTML] - contains <strong> tags → use data-th
'about-what-p2': {
  en: "We're also listed on <strong>Airbnb</strong>, <strong>Booking.com</strong>, <strong>Agoda</strong>, <strong>Trip.com</strong>, and <strong>DayLaDau</strong>, where guests have rated us 9.3 and awarded us Superhost status. But when you book directly through our website, you get better rates, more flexibility, and direct communication with the people who actually host you.",
  vn: 'Chúng tôi cũng có mặt trên <strong>Airbnb</strong>, <strong>Booking.com</strong>, <strong>Agoda</strong>, <strong>Trip.com</strong> và <strong>DayLaDau</strong>, nơi khách đã đánh giá chúng tôi 9.3 và trao tặng danh hiệu Superhost. Nhưng khi bạn đặt phòng trực tiếp qua trang web của chúng tôi, bạn sẽ có giá tốt hơn, linh hoạt hơn và giao tiếp trực tiếp với những người thực sự tiếp đón bạn.',
  zh: '我们也在<strong>Airbnb</strong>、<strong>Booking.com</strong>、<strong>Agoda</strong>、<strong>Trip.com</strong>和<strong>DayLaDau</strong>上，客人们给我们打了9.3分并授予我们超赞房东身份。但当您通过我们的网站直接预订时，您可以获得更好的价格、更多的灵活性，并与真正接待您的人直接沟通。'
},
// [HTML] - contains <strong> tags → use data-th
'about-what-p3': {
  en: 'MiaCasa sits between a hotel and an Airbnb stay. You get the <strong>privacy and independence</strong> of a rental, plus the <strong>attention and local knowledge</strong> of hosts who genuinely care about your experience.',
  vn: 'MiaCasa nằm giữa khách sạn và Airbnb. Bạn có được <strong>sự riêng tư và độc lập</strong> của một căn hộ cho thuê, cùng với <strong>sự quan tâm và kiến thức địa phương</strong> của những người chủ thực sự quan tâm đến trải nghiệm của bạn.',
  zh: 'MiaCasa介于酒店和Airbnb之间。您既可以享受出租房的<strong>私密性和独立性</strong>，又能得到真正关心您体验的房东的<strong>关注和本地知识</strong>。'
},
/* ── ABOUT PAGE - NEW KEYS ── */
'about-last-updated': {
  en: 'Updated July 2026',
  vn: 'Cập nhật tháng 7 năm 2026',
  zh: '2026年7月更新'
},
'about-languages': {
  en: '🇬🇧 🇻🇳 🇨🇳 We welcome guests from around the world and provide information in English, Vietnamese, and Chinese.',
  vn: '🇬🇧 🇻🇳 🇨🇳 Chúng tôi chào đón khách từ khắp nơi trên thế giới và cung cấp thông tin bằng tiếng Anh, tiếng Việt và tiếng Trung.',
  zh: '🇬🇧 🇻🇳 🇨🇳 我们欢迎来自世界各地的客人，并提供英语、越南语和中文的信息。'
},
'about-trip-title': {
  en: 'Planning Your Trip to Hanoi?',
  vn: 'Đang lên kế hoạch cho chuyến đi Hà Nội?',
...
'about-trip-desc': {
  en: 'Everything you need to plan your Hanoi visit:',
  vn: 'Mọi thứ bạn cần để lên kế hoạch cho chuyến thăm Hà Nội:',
  zh: '规划河内之旅所需的一切：'
},
'about-trip-itinerary': {
  en: 'How many days in Hanoi?',
  vn: 'Nên ở Hà Nội bao nhiêu ngày?',
  zh: '在河内待几天？'
},
'about-trip-stay': {
  en: 'Where should you stay?',
  vn: 'Nên ở đâu?',
  zh: '应该住在哪里？'
},
'about-trip-cafes': {
  en: 'Best cafés',
  vn: 'Quán cà phê đẹp nhất',
  zh: '最佳咖啡馆'
},
'about-trip-food': {
  en: 'Local food guide',
  vn: 'Hướng dẫn ẩm thực địa phương',
  zh: '本地美食指南'
},
'about-trip-train': {
  en: 'Train Street guide',
...
'about-trip-oq': {
  en: 'Old Quarter guide',
  vn: 'Hướng dẫn Phố Cổ',
  zh: '老城区指南'
},
// More Personal Than a Hotel
'about-personal-title': { en: 'More Personal Than a Hotel', vn: 'Cá Nhân Hóa Hơn Khách Sạn', zh: '比酒店更个性化' },
'about-personal-p1': {
  en: 'Hotels often provide consistency, while Airbnb stays can vary from host to host. MiaCasa combines the comfort of a private stay with the support of local hosts.',
  vn: 'Khách sạn thường mang lại sự nhất quán, trong khi Airbnb có thể khác nhau tùy từng chủ nhà. MiaCasa kết hợp sự thoải mái của một chỗ nghỉ riêng tư với sự hỗ trợ của chủ nhà địa phương.',
  zh: '酒店通常提供一致性，而Airbnb的体验因房东而异。MiaCasa结合了私人住宿的舒适性和本地房东的支持。'
},
'about-personal-p2': { en: 'We offer:', vn: 'Chúng tôi cung cấp:', zh: '我们提供：' },
// [HTML] - contains <strong> tags → use data-th
'about-personal-li1': { en: '<strong>Local hosts</strong> who understand Hanoi and genuinely care about your stay', vn: '<strong>Chủ nhà địa phương</strong> hiểu Hà Nội và thực sự quan tâm đến kỳ nghỉ của bạn', zh: '<strong>当地房东</strong>了解河内并真正关心您的住宿' },
// [HTML] - contains <strong> tags → use data-th
'about-personal-li2': { en: '<strong>Direct communication</strong> before, during, and after your stay', vn: '<strong>Giao tiếp trực tiếp</strong> trước, trong và sau kỳ nghỉ của bạn', zh: '<strong>直接沟通</strong>在您入住前、入住期间和入住后' },
// [HTML] - contains <strong> tags → use data-th
'about-personal-li3': { en: '<strong>Thoughtfully designed spaces</strong> — not staged for photos, but lived-in and comfortable', vn: '<strong>Không gian được thiết kế chu đáo</strong> — không chỉ để chụp ảnh, mà còn thoải mái và dễ sống', zh: '<strong>精心设计的空间</strong> — 不为拍照而布置，而是宜居舒适' },
// [HTML] - contains <strong> tags → use data-th
'about-personal-li4': { en: '<strong>Better value</strong> through direct booking with no platform commissions', vn: '<strong>Giá trị tốt hơn</strong> qua đặt phòng trực tiếp không qua nền tảng trung gian', zh: '<strong>更好的价值</strong>通过直接预订，无平台佣金' },
'about-personal-p3': { en: 'Over the years, we have welcomed solo travelers, couples, families, remote workers, and long-term visitors from dozens of countries. Many guests arrive as visitors and leave feeling connected to the city in a completely different way.', vn: 'Qua nhiều năm, chúng tôi đã chào đón khách du lịch độc hành, các cặp đôi, gia đình, nhân viên làm việc từ xa và du khách dài hạn từ hàng chục quốc gia. Nhiều khách đến như những du khách và rời đi với cảm giác kết nối với thành phố theo một cách hoàn toàn khác.', zh: '多年来，我们接待了来自数十个国家的独行旅客、情侣、家庭、远程工作者和长期访客。许多客人作为游客到来，离开时却以一种完全不同的方式与这座城市产生了联系。' },

// Meet Your Hosts
'about-hosts-title': { en: 'Meet Your Hosts', vn: 'Gặp Gỡ Chủ Nhà Của Bạn', zh: '认识你的房东' },
'about-hosts-desc': { en: 'We live in Hanoi and personally care for our guests and properties.', vn: 'Chúng tôi sống ở Hà Nội và trực tiếp chăm sóc khách hàng cũng như bất động sản của mình.', zh: '我们住在河内，亲自照顾我们的客人和物业。' },
'about-host-name': { en: 'Linh', vn: 'Linh', zh: 'Linh' },
'about-host-role': { en: 'Co-founder · MiaCasa', vn: 'Đồng sáng lập · MiaCasa', zh: '联合创始人 · MiaCasa' },
'about-host-name-2': { en: 'Ngọc', vn: 'Ngọc', zh: 'Ngọc' },
'about-host-role-2': { en: 'Co-founder · MiaCasa', vn: 'Đồng sáng lập · MiaCasa', zh: '联合创始人 · MiaCasa' },
// [HTML] - contains <a> tag → use data-th
'about-hosts-read-more': { en: '<a href="/our-story" style="color:#c17a5a;text-decoration:none;">Read our full story →</a>', vn: '<a href="/our-story" style="color:#c17a5a;text-decoration:none;">Đọc toàn bộ câu chuyện →</a>', zh: '<a href="/our-story" style="color:#c17a5a;text-decoration:none;">阅读完整故事 →</a>' },

// Two Properties
'about-properties-title': { en: 'Two Ways to Experience Hanoi', vn: 'Hai Cách Để Trải Nghiệm Hà Nội', zh: '体验河内的两种方式' },
'about-properties-intro': { en: 'Different locations. Different atmospheres. Same commitment to honest hospitality.', vn: 'Vị trí khác nhau. Không khí khác nhau. Cam kết chung về lòng hiếu khách chân thành.', zh: '不同的位置。不同的氛围。对真诚待客的共同承诺。' },
'about-property-hanoi-tag': { en: '🌿 Quiet Local Neighborhood', vn: '🌿 Khu Phố Yên Tĩnh', zh: '🌿 安静的当地社区' },
'about-property-hanoi-title': { en: 'MiaCasa Hanoi', vn: 'MiaCasa Hà Nội', zh: 'MiaCasa河内' },
'about-property-hanoi-desc': { en: 'Private rooms in a quiet residential area near Văn Miếu and Train Street. Ideal for couples and solo travelers.', vn: 'Phòng riêng trong khu dân cư yên tĩnh gần Văn Miếu và Phố Tàu. Lý tưởng cho các cặp đôi và khách du lịch độc hành.', zh: '文庙和火车街附近安静住宅区的私人房间。适合情侣和独行旅客。' },
'about-property-hanoi-li1': { en: '3 private ensuite rooms', vn: '3 phòng riêng có phòng tắm', zh: '3间私人套间' },
'about-property-hanoi-li2': { en: 'Kitchenettes in every room', vn: 'Bếp nhỏ trong mỗi phòng', zh: '每间房间都有小厨房' },
'about-property-hanoi-li3': { en: 'Quiet residential surroundings', vn: 'Khu dân cư yên tĩnh', zh: '安静的住宅环境' },
'about-property-hanoi-btn': { en: 'View property →', vn: 'Xem bất động sản →', zh: '查看物业 →' },

'about-property-oq-tag': { en: '🏙️ Heart of Old Quarter', vn: '🏙️ Trung Tâm Phố Cổ', zh: '🏙️ 三十六行街中心' },
'about-property-oq-title': { en: 'MiaCasa Old Quarter', vn: 'MiaCasa Phố Cổ', zh: 'MiaCasa三十六行街' },
'about-property-oq-desc': { en: 'A full apartment in Hanoi\'s historic district, close to Hoàn Kiếm Lake. Ideal for families and groups.', vn: 'Toàn bộ căn hộ trong khu phố lịch sử của Hà Nội, gần Hồ Hoàn Kiếm. Lý tưởng cho gia đình và nhóm.', zh: '河内历史区的整间公寓，靠近还剑湖。适合家庭和团体。' },
'about-property-oq-li1': { en: '3 queen beds', vn: '3 giường đôi', zh: '3张大床' },
'about-property-oq-li2': { en: 'Private apartment', vn: 'Căn hộ riêng', zh: '私人公寓' },
'about-property-oq-li3': { en: 'Walking access to attractions', vn: 'Đi bộ đến các điểm tham quan', zh: '步行可达景点' },
'about-property-oq-btn': { en: 'View property →', vn: 'Xem bất động sản →', zh: '查看物业 →' },

// Local Knowledge
'about-knowledge-title': { en: 'Local Knowledge Matters', vn: 'Kiến Thức Địa Phương Quan Trọng', zh: '本地知识很重要' },
'about-knowledge-p1': { en: 'Living in Hanoi allows us to help guests discover experiences that many visitors miss. We regularly share recommendations about cafés, street food, neighborhood walks, hidden restaurants, day trips, transportation, and cultural etiquette.', vn: 'Sống ở Hà Nội cho phép chúng tôi giúp khách khám phá những trải nghiệm mà nhiều du khách bỏ lỡ. Chúng tôi thường xuyên chia sẻ các gợi ý về cà phê, ẩm thực đường phố, đi bộ trong khu phố, nhà hàng ẩn, chuyến đi trong ngày, phương tiện di chuyển và phép tắc văn hóa.', zh: '住在河内让我们能够帮助客人发现许多游客错过的体验。我们定期分享关于咖啡馆、街头美食、社区漫步、隐藏餐厅、一日游、交通和文化礼仪的建议。' },
'about-knowledge-p2': { en: 'Read our travel guides to plan your visit:', vn: 'Đọc các hướng dẫn du lịch của chúng tôi để lên kế hoạch cho chuyến đi của bạn:', zh: '阅读我们的旅游指南来规划您的行程：' },
'about-blog-food': { en: 'What to Eat in Hanoi', vn: 'Ăn Gì Ở Hà Nội', zh: '河内吃什么' },
'about-blog-oq': { en: 'Old Quarter Guide', vn: 'Hướng Dẫn Phố Cổ', zh: '三十六行街指南' },
'about-blog-cafes': { en: 'Best Cafés in Hanoi', vn: 'Quán Cà Phê Tốt Nhất Hà Nội', zh: '河内最好的咖啡馆' },
'about-blog-train': { en: 'Train Street Guide', vn: 'Hướng Dẫn Phố Tàu', zh: '火车街指南' },
'about-blog-itinerary': { en: '3-Day Itinerary', vn: 'Lịch Trình 3 Ngày', zh: '3天行程' },
'about-blog-stay': { en: 'Where to Stay in Hanoi', vn: 'Ở Đâu Tại Hà Nội', zh: '河内住在哪里' },
// [HTML] - contains <a> tag → use data-th
'about-knowledge-p3': { en: '<a href="/blog" style="color:#c17a5a;text-decoration:none;">Read all blog posts →</a>', vn: '<a href="/blog" style="color:#c17a5a;text-decoration:none;">Đọc tất cả bài viết →</a>', zh: '<a href="/blog" style="color:#c17a5a;text-decoration:none;">阅读所有博客文章 →</a>' },

// Direct Booking
'about-direct-title': { en: 'Why Book Direct?', vn: 'Tại Sao Nên Đặt Phòng Trực Tiếp?', zh: '为什么直接预订？' },
// [HTML] - contains <strong> tags → use data-th
'about-direct-p1': { en: 'Yes, you can find us on <strong>Airbnb</strong> and <strong>Booking.com</strong>. But direct booking offers clear advantages:', vn: 'Có, bạn có thể tìm thấy chúng tôi trên <strong>Airbnb</strong> và <strong>Booking.com</strong>. Nhưng đặt phòng trực tiếp mang lại những lợi thế rõ ràng:', zh: '是的，您可以在<strong>Airbnb</strong>和<strong>Booking.com</strong>上找到我们。但直接预订有明显的优势：' },
// [HTML] - contains <strong> tags → use data-th
'about-direct-li1': { en: '<strong>Better rates</strong> — no platform commissions, lower prices', vn: '<strong>Giá tốt hơn</strong> — không có hoa hồng nền tảng, giá thấp hơn', zh: '<strong>更好的价格</strong> — 无平台佣金，价格更低' },
// [HTML] - contains <strong> tags → use data-th
'about-direct-li2': { en: '<strong>Flexible payment</strong> — more options, including cash at check-in', vn: '<strong>Thanh toán linh hoạt</strong> — nhiều lựa chọn hơn, bao gồm thanh toán bằng tiền mặt khi nhận phòng', zh: '<strong>灵活支付</strong> — 更多选择，包括入住时现金支付' },
// [HTML] - contains <strong> tags → use data-th
'about-direct-li3': { en: '<strong>Direct communication</strong> — speak with hosts, not a platform', vn: '<strong>Giao tiếp trực tiếp</strong> — nói chuyện với chủ nhà, không qua nền tảng trung gian', zh: '<strong>直接沟通</strong> — 与房东交谈，而不是平台' },
// [HTML] - contains <strong> tags → use data-th
'about-direct-li4': { en: '<strong>Faster support</strong> — we respond within hours, not days', vn: '<strong>Hỗ trợ nhanh hơn</strong> — chúng tôi phản hồi trong vòng vài giờ, không phải vài ngày', zh: '<strong>更快的支持</strong> — 我们在几小时内回复，而不是几天' },
// [HTML] - contains <strong> tags → use data-th
'about-direct-li5': { en: '<strong>Personalized recommendations</strong> — tailored to your interests', vn: '<strong>Gợi ý cá nhân hóa</strong> — phù hợp với sở thích của bạn', zh: '<strong>个性化推荐</strong> — 根据您的兴趣定制' },
'about-direct-p2': { en: 'Book direct and experience the same trusted MiaCasa stay with more flexibility and better value.', vn: 'Đặt phòng trực tiếp và trải nghiệm kỳ nghỉ MiaCasa đáng tin cậy tương tự với sự linh hoạt hơn và giá trị tốt hơn.', zh: '直接预订，体验同样值得信赖的MiaCasa住宿，更加灵活，价值更好。' },
...
'about-faq-a1': {
  en: 'MiaCasa is a boutique homestay in Hanoi — more personal than a hotel, with local hosts who live in the city and personally manage two distinct properties.',
  vn: 'MiaCasa là một homestay boutique tại Hà Nội — cá nhân hóa hơn khách sạn, với những chủ nhà địa phương sống trong thành phố và trực tiếp quản lý hai bất động sản khác nhau.',
  zh: 'MiaCasa是河内的一家精品寄宿家庭 — 比酒店更个性化，有居住在这座城市的当地房东亲自管理两处不同的物业。'
},
'about-faq-q2': {
  en: 'Is MiaCasa a hotel?',
  vn: 'MiaCasa có phải là khách sạn không?',
  zh: 'MiaCasa是酒店吗？'
},
'about-faq-a2': {
  en: 'No, MiaCasa is a boutique homestay — smaller and more personal than a hotel. We offer private rooms and apartments with the independence of a rental, plus local hosts who actually care.',
  vn: 'Không, MiaCasa là một homestay boutique — nhỏ hơn và cá nhân hóa hơn khách sạn. Chúng tôi cung cấp phòng và căn hộ riêng với sự độc lập như một căn hộ cho thuê, cùng với những chủ nhà địa phương thực sự quan tâm.',
  zh: '不，MiaCasa是一家精品寄宿家庭 — 比酒店更小、更个性化。我们提供私人房间和公寓，具有出租房的独立性，还有真正关心您的当地房东。'
},
'about-faq-q3': {
  en: 'Is MiaCasa on Airbnb?',
  vn: 'MiaCasa có trên Airbnb không?',
  zh: 'MiaCasa在Airbnb上吗？'
},
'about-faq-a3': {
  en: 'Yes, you can find MiaCasa on <strong>Airbnb</strong>, <strong>Booking.com</strong>, <strong>Agoda</strong>, <strong>Trip.com</strong>, and <strong>DayLaDau</strong>. However, booking directly through our website offers better rates, flexible payment options, and direct communication with hosts.',
  vn: 'Có, bạn có thể tìm thấy MiaCasa trên <strong>Airbnb</strong>, <strong>Booking.com</strong>, <strong>Agoda</strong>, <strong>Trip.com</strong> và <strong>DayLaDau</strong>. Tuy nhiên, đặt phòng trực tiếp qua trang web của chúng tôi mang lại giá tốt hơn, tùy chọn thanh toán linh hoạt và giao tiếp trực tiếp với chủ nhà.',
  zh: '是的，您可以在<strong>Airbnb</strong>、<strong>Booking.com</strong>、<strong>Agoda</strong>、<strong>Trip.com</strong>和<strong>DayLaDau</strong>上找到MiaCasa。但是，通过我们的网站直接预订可以获得更好的价格、灵活的支付选项以及与房东的直接沟通。'
},
'about-faq-q5': {
  en: 'Why book direct?',
  vn: 'Tại sao nên đặt trực tiếp?',
  zh: '为什么直接预订？'
},
'about-faq-a5': {
  en: 'Booking directly through our website offers better rates, flexible payment options, and direct communication with hosts. No platform commissions means lower prices for you.',
  vn: 'Đặt phòng trực tiếp qua trang web của chúng tôi mang lại giá tốt hơn, tùy chọn thanh toán linh hoạt và giao tiếp trực tiếp với chủ nhà. Không có phí nền tảng có nghĩa là giá thấp hơn cho bạn.',
  zh: '通过我们的网站直接预订可以获得更好的价格、灵活的支付选项以及与房东的直接沟通。没有平台佣金意味着您享受更低的价格。'
},
'about-faq-q6': {
  en: 'Which property should I choose?',
  vn: 'Tôi nên chọn bất động sản nào?',
  zh: '我应该选择哪个物业？'
},
'about-faq-a6': {
  en: 'Choose MiaCasa Hanoi for a quieter, local neighborhood experience near Văn Miếu and Train Street. Choose MiaCasa Old Quarter for staying in the heart of Hanoi\'s historic district.',
  vn: 'Chọn MiaCasa Hà Nội để có trải nghiệm yên tĩnh hơn, mang tính địa phương gần Văn Miếu và Phố Tàu. Chọn MiaCasa Phố Cổ để ở ngay trung tâm khu phố lịch sử của Hà Nội.',
  zh: '选择MiaCasa河内可以在文庙和火车街附近获得更安静、更本地化的社区体验。选择MiaCasa三十六行街可以入住河内历史区的中心。'
},
// About MiaCasa Page - New Keys
/* ── ABOUT PAGE - MAPS SECTION ── */
'about-maps-title': {
  en: 'Where Are We?',
  vn: 'Chúng Tôi Ở Đâu?',
  zh: '我们在哪里？'
...
'about-maps-desc': {
  en: 'MiaCasa offers two different neighborhoods in Hanoi:',
  vn: 'MiaCasa có hai địa điểm khác nhau tại Hà Nội:',
  zh: 'MiaCasa在河内提供两个不同的社区：'
},
'about-maps-hanoi-title': {
  en: '📍 MiaCasa Hanoi',
  vn: '📍 MiaCasa Hà Nội',
  zh: '📍 MiaCasa河内'
},
'about-maps-hanoi-desc': {
  en: '92 Ngh. 51 Ng. Linh Quang, Văn Chương, Văn Miếu – Quốc Tử Giám, Hà Nội',
  vn: '92 Ngõ 51 Ng. Linh Quang, Văn Chương, Văn Miếu – Quốc Tử Giám, Hà Nội',
  zh: '92 Ngh. 51 Ng. Linh Quang, Văn Chương, Văn Miếu – Quốc Tử Giám, 河内'
},
'about-maps-hanoi-link': {
  en: 'View location & directions →',
  vn: 'Xem vị trí và chỉ đường →',
  zh: '查看位置和路线 →'
},
'about-maps-oq-title': {
  en: '📍 MiaCasa Old Quarter',
...
'about-maps-oq-desc': {
  en: '38 P. Lương Ngọc Quyến, Hàng Buồm, Hoàn Kiếm, Hà Nội',
  vn: '38 P. Lương Ngọc Quyến, Hàng Buồm, Hoàn Kiếm, Hà Nội',
  zh: '38 P. Lương Ngọc Quyến, Hàng Buồm, Hoàn Kiếm, 河内'
},
'about-maps-oq-link': {
  en: 'View location & directions →',
  vn: 'Xem vị trí và chỉ đường →',
...
// Welcome
'about-welcome-title': { en: 'Welcome to Hanoi', vn: 'Chào Mừng Đến Hà Nội', zh: '欢迎来到河内' },
'about-welcome-p1': { en: 'Whether you stay in the Old Quarter or in one of Hanoi\'s quieter neighborhoods, we hope MiaCasa becomes part of your journey.', vn: 'Dù bạn ở tại Phố Cổ hay một trong những khu phố yên tĩnh hơn của Hà Nội, chúng tôi hy vọng MiaCasa sẽ trở thành một phần trong hành trình của bạn.', zh: '无论您住在三十六行街还是河内更安静的社区，我们希望MiaCasa成为您旅程的一部分。' },
'about-welcome-p2': { en: 'We look forward to welcoming you to Hanoi.', vn: 'Chúng tôi mong được chào đón bạn đến Hà Nội.', zh: '我们期待在河内欢迎您。' },

// Signoff & CTA
// [HTML] - contains <br> tag → use data-th
'about-signoff': { en: 'MiaCasa Homestays<br>Local hosts. Honest recommendations. A home in Hanoi.', vn: 'MiaCasa Homestays<br>Chủ nhà địa phương. Lời khuyên trung thực. Một ngôi nhà ở Hà Nội.', zh: 'MiaCasa寄宿家庭<br>当地房东。诚实的建议。河内的家。' },
'about-cta-book': { en: '📅 Book Your Stay', vn: '📅 Đặt Phòng Của Bạn', zh: '📅 预订您的住宿' },
'about-cta-blog': { en: '📖 Read Our Blog', vn: '📖 Đọc Blog Của Chúng Tôi', zh: '📖 阅读我们的博客' },

// In your translations object:

// English
// In the TRANSLATIONS object, these keys need to be objects, not strings:

// English section
'returning-tag': { en: 'Returning Guests', vn: 'Khách quay lại', zh: '回访客人' },
'returning-title': { en: 'Manage your <em>existing booking</em>', vn: 'Quản lý đặt phòng hiện tại của bạn', zh: '管理您现有的预订' },
'invoice-icon-label': { en: 'Invoice', vn: 'Hóa đơn', zh: '发票' },
'cancel-icon-label': { en: 'Cancel', vn: 'Hủy', zh: '取消' },
'review-icon-label': { en: 'Review', vn: 'Đánh giá', zh: '评论' },
'review-link': { en: 'Write a review →', vn: 'Viết đánh giá →', zh: '发表评论 →' },
'review-text': { en: 'Share your experience with others', vn: 'Chia sẻ trải nghiệm của bạn với mọi người', zh: '与他人分享您的体验' },
'review-hanoi': { en: '⭐ MiaCasa Hanoi', vn: '⭐ MiaCasa Hà Nội', zh: '⭐ MiaCasa 河内' },
'review-oq': { en: '⭐ MiaCasa Old Quarter', vn: '⭐ MiaCasa Phố Cổ', zh: '⭐ MiaCasa 老城区' },

// Review Modal - CORRECTED (all as objects)
'review-modal-title': { 
    en: 'Verify Your Stay', 
    vn: 'Xác minh đặt phòng của bạn', 
    zh: '验证您的住宿' 
},
'review-modal-sub': { 
    en: 'Please enter your Booking ID to verify you\'re a guest', 
    vn: 'Vui lòng nhập Mã đặt phòng để xác minh bạn là khách', 
    zh: '请输入您的预订ID以验证您是住客' 
},
'review-booking-label': { 
    en: 'Booking ID', 
    vn: 'Mã đặt phòng', 
    zh: '预订ID' 
},
'review-help': { 
    en: 'Your Booking ID is in your confirmation email', 
    vn: 'Mã đặt phòng có trong email xác nhận của bạn', 
    zh: '您的预订ID在确认邮件中' 
},
'review-property-label': { 
    en: 'Which property did you stay at?', 
    vn: 'Bạn đã ở tại cơ sở nào?', 
    zh: '您入住的是哪个物业？' 
},
'review-select-property': { 
...
'review-submit-btn': { 
    ...
    vn: 'Tiếp tục đánh giá →', 
    zh: '继续评价 →' 
},
'review-note': { 
    en: 'Don\'t have your Booking ID? Contact us and we\'ll help.', 
    vn: 'Không có Mã đặt phòng? Liên hệ với chúng tôi để được giúp đỡ.', 
    zh: '没有预订ID？联系我们获取帮助。' 
},
'review-contact-link': { 
    en: 'Contact us', 
...
// Navigation
'nav-about': { en: 'About', vn: 'Giới thiệu', zh: '关于' },
'footer-about': { en: 'About MiaCasa', vn: 'Về MiaCasa', zh: '关于MiaCasa' },
// Add to TRANSLATIONS object (near the bottom, before the closing brace)
...
"admin-tab-cancellations": {
  en: "❌ Cancellations & Refunds",
  vn: "❌ Hủy Phòng & Hoàn Tiền",
  zh: "❌ 取消与退款"
},

"admin-pending-payment": {
  en: "Pending Payment",
  vn: "Đang chờ thanh toán",
  zh: "待付款"
},
...
"admin-no-pending-bookings": {
  en: "✅ No pending bookings",
  vn: "✅ Không có đặt phòng đang chờ",
  zh: "✅ 暂无待处理预订"
},

"admin-pending-bookings-count": {
  en: "booking(s) awaiting payment confirmation",
  vn: "đặt phòng đang chờ xác nhận thanh toán",
  zh: "个预订等待付款确认"
},

"admin-paypal-pending": {
  en: "💳 PayPal (pending confirmation)",
  vn: "💳 PayPal (đang chờ xác nhận)",
  zh: "💳 PayPal（待确认）"
},

"admin-vietqr-pending": {
  en: "🏦 VietQR (pending verification)",
  vn: "🏦 VietQR (đang chờ xác minh)",
  zh: "🏦 VietQR（待验证）"
},
...
"admin-no-pending-cancellations": {
  en: "✅ No pending cancellation requests",
  vn: "✅ Không có yêu cầu hủy phòng đang chờ",
  zh: "✅ 暂无待处理的取消请求"
},
...
"admin-free-eligible": {
  en: "Free eligible",
  vn: "Đủ điều kiện hoàn tiền",
  zh: "符合免费取消"
},

"admin-approve-refund": {
  en: "✅ Approve Refund",
  vn: "✅ Xác nhận hoàn tiền",
  zh: "✅ 批准退款"
},
...
"admin-refund-confirmed": {
  en: "✅ Refund confirmed",
  vn: "✅ Đã xác nhận hoàn tiền",
  zh: "✅ 退款已确认"
},
...
"admin-please-login": {
  en: "Please log in to view",
  vn: "Vui lòng đăng nhập để xem",
  zh: "请登录查看"
},
/* ── ADMIN PANEL TRANSLATIONS (ADD THESE TO TRANSLATIONS OBJECT) ── */
...
"admin-session-expired": {
  ...
  vn: "Phiên đăng nhập đã hết hạn. Vui lòng đăng nhập lại.",
  zh: "会话已过期，请重新登录。"
},
"admin-unknown-error": {
  en: "Unknown error",
...
// Add to TRANSLATIONS object in lang.js
...
"admin-payments-how-it-works": {
  en: "How it works:",
  vn: "Cách thức hoạt động:"
},
"admin-payments-description": {
  en: "When a guest books with PayPal or VietQR, the booking is saved with status \"pending\". After you confirm payment in your PayPal account or bank, click \"Confirm Payment\" to:",
  vn: "Khi khách đặt phòng qua PayPal hoặc VietQR, đặt phòng được lưu với trạng thái \"đang chờ\". Sau khi bạn xác nhận thanh toán trong tài khoản PayPal hoặc ngân hàng, nhấn \"Xác nhận thanh toán\" để:"
},
"admin-payments-step1": {
  en: "Update the booking status to \"paid\"",
  vn: "Cập nhật trạng thái đặt phòng thành \"đã thanh toán\""
},
"admin-payments-step2": {
  en: "Send the confirmation email to the guest with check-in instructions",
  vn: "Gửi email xác nhận cho khách kèm hướng dẫn nhận phòng"
},
"admin-payments-tip": {
  en: "💡 Both PayPal and VietQR bookings appear here for easy management.",
  vn: "💡 Cả đặt phòng PayPal và VietQR đều xuất hiện tại đây để dễ dàng quản lý."
},
"admin-cancellations-title": {
  en: "❌ Cancellations & Refunds",
  vn: "❌ Hủy Phòng & Hoàn Tiền"
},
"admin-cancellations-description": {
  en: "Review and process guest cancellation requests.",
  vn: "Xem xét và xử lý yêu cầu hủy phòng của khách."
},
"admin-cancellations-instructions": {
  en: "Click \"Approve Refund\" to process a refund, or \"Reject\" to decline the cancellation.",
  vn: "Nhấn \"Xác nhận hoàn tiền\" để xử lý hoàn tiền, hoặc \"Từ chối\" để từ chối yêu cầu hủy."
},
"admin-cancellations-policy-title": {
  en: "📌 Cancellation Policy:",
  vn: "📌 Chính sách hủy phòng:"
},
"admin-cancellations-policy1": {
  en: "✅ Free cancellation up to 48 hours before check-in",
  vn: "✅ Hủy miễn phí đến 48 giờ trước khi nhận phòng"
},
"admin-cancellations-policy2": {
  en: "⚠️ Cancellations within 48 hours may incur a fee",
  vn: "⚠️ Hủy trong vòng 48 giờ có thể mất phí"
},
"admin-cancellations-policy3": {
  en: "❌ No refunds after check-in",
  vn: "❌ Không hoàn tiền sau khi đã nhận phòng"
}
};
