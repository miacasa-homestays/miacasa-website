...
'about-personal-p1': { en: 'Hotels can feel impersonal. Airbnb can feel like you\'re on your own. MiaCasa is different.', vn: 'Khách sạn có thể cảm thấy vô cảm. Airbnb có thể khiến bạn cảm thấy cô đơn. MiaCasa khác biệt.', zh: '酒店可能感觉没有人情味。Airbnb可能让你感觉独自一人。MiaCasa与众不同。' },
...
// FAQ
'about-faq-title': { en: 'Frequently Asked Questions', vn: 'Câu Hỏi Thường Gặp', zh: '常见问题' },
'about-faq-q1': { en: 'What is MiaCasa?', vn: 'MiaCasa là gì?', zh: '什么是MiaCasa？' },
'about-faq-a1': { en: 'MiaCasa is a boutique homestay in Hanoi — more personal than a hotel, with local hosts who live in the city and personally manage two distinct properties.', vn: 'MiaCasa là một homestay boutique tại Hà Nội — cá nhân hóa hơn khách sạn, với những chủ nhà địa phương sống trong thành phố và trực tiếp quản lý hai bất động sản khác nhau.', zh: 'MiaCasa是河内的一家精品寄宿家庭 — 比酒店更个性化，有居住在这座城市的当地房东亲自管理两处不同的物业。' },
'about-faq-q2': { en: 'Is MiaCasa a hotel?', vn: 'MiaCasa có phải là khách sạn không?', zh: 'MiaCasa是酒店吗？' },
'about-faq-a2': { en: 'No, MiaCasa is a boutique homestay — smaller and more personal than a hotel. We offer private rooms and apartments with the independence of a rental, plus local hosts who actually care.', vn: 'Không, MiaCasa là một homestay boutique — nhỏ hơn và cá nhân hóa hơn khách sạn. Chúng tôi cung cấp phòng và căn hộ riêng với sự độc lập như một căn hộ cho thuê, cùng với những chủ nhà địa phương thực sự quan tâm.', zh: '不，MiaCasa是一家精品寄宿家庭 — 比酒店更小、更个性化。我们提供私人房间和公寓，具有出租房的独立性，还有真正关心您的当地房东。' },
'about-faq-q3': { en: 'Is MiaCasa on Airbnb?', vn: 'MiaCasa có trên Airbnb không?', zh: 'MiaCasa在Airbnb上吗？' },
'about-faq-a3': {
...
'about-faq-q4': { en: 'Who manages MiaCasa?', vn: 'Ai quản lý MiaCasa?', zh: '谁管理MiaCasa？' },
'about-faq-a4': { en: 'MiaCasa is managed by local hosts who live in Hanoi. We are not a remote management company — we personally care for our properties and guests.', vn: 'MiaCasa được quản lý bởi những chủ nhà địa phương sống tại Hà Nội. Chúng tôi không phải là một công ty quản lý từ xa — chúng tôi trực tiếp chăm sóc bất động sản và khách hàng của mình.', zh: 'MiaCasa由居住在河内的当地房东管理。我们不是远程管理公司 — 我们亲自照顾我们的物业和客人。' },
'about-faq-q5': { en: 'Why stay at MiaCasa?', vn: 'Tại sao nên ở tại MiaCasa?', zh: '为什么选择MiaCasa？' },
'about-faq-a5': { en: 'Stay for local hosts who understand Hanoi, honest recommendations, comfortable spaces, and a more authentic experience of the city. Direct booking offers better rates and direct communication.', vn: 'Ở tại MiaCasa để có chủ nhà địa phương hiểu Hà Nội, những lời khuyên trung thực, không gian thoải mái và trải nghiệm chân thực hơn về thành phố. Đặt phòng trực tiếp mang lại giá tốt hơn và giao tiếp trực tiếp.', zh: '选择MiaCasa是为了了解河内的当地房东、诚实的建议、舒适的空间以及更真实的城市体验。直接预订提供更好的价格和直接沟通。' },
'about-faq-q6': { en: 'Which property should I choose?', vn: 'Tôi nên chọn bất động sản nào?', zh: '我应该选择哪个物业？' },
'about-faq-a6': { en: 'Choose MiaCasa Hanoi for a quieter, local neighborhood experience near Văn Miếu and Train Street. Choose MiaCasa Old Quarter for staying in the heart of Hanoi\'s historic district.', vn: 'Chọn MiaCasa Hà Nội để có trải nghiệm yên tĩnh hơn, mang tính địa phương gần Văn Miếu và Phố Tàu. Chọn MiaCasa Phố Cổ để ở ngay trung tâm khu phố lịch sử của Hà Nội.', zh: '选择MiaCasa河内可以在文庙和火车街附近获得更安静、更本地化的社区体验。选择MiaCasa三十六行街可以入住河内历史区的中心。' },
'about-faq-q7': { en: 'What makes MiaCasa different from Airbnb?', vn: 'Điều gì làm cho MiaCasa khác biệt với Airbnb?', zh: 'MiaCasa与Airbnb有什么不同？' },
'about-faq-a7': { en: 'MiaCasa is a dedicated homestay with local hosts who personally manage the properties. Unlike many Airbnb listings, our hosts are available directly, we maintain consistent quality across stays, and we offer a more personal experience with local knowledge of Hanoi. We also offer direct booking with better rates and flexible payment.', vn: 'MiaCasa là một homestay chuyên biệt với những chủ nhà địa phương trực tiếp quản lý bất động sản. Không giống như nhiều danh sách trên Airbnb, chủ nhà của chúng tôi có mặt trực tiếp, chúng tôi duy trì chất lượng nhất quán qua các kỳ nghỉ và chúng tôi mang lại trải nghiệm cá nhân hóa hơn với kiến thức địa phương về Hà Nội. Chúng tôi cũng cung cấp đặt phòng trực tiếp với giá tốt hơn và thanh toán linh hoạt.', zh: 'MiaCasa是一家专门的寄宿家庭，有当地房东亲自管理物业。与许多Airbnb房源不同，我们的房东可以直接联系，我们在每次住宿中保持一贯的品质，我们提供更个性化的体验和河内的本地知识。我们还提供直接预订，价格更好，支付灵活。' },
// About MiaCasa Page - New Keys
'about-maps-title': { en: 'Where Are We?', vn: 'Chúng Tôi Ở Đâu?', zh: '我们在哪里？' },
'about-maps-desc': { en: 'MiaCasa offers two different neighborhoods in Hanoi:', vn: 'MiaCasa có hai địa điểm khác nhau tại Hà Nội:', zh: 'MiaCasa在河内提供两个不同的社区：' },
'about-maps-hanoi-title': { en: '📍 MiaCasa Hanoi', vn: '📍 MiaCasa Hà Nội', zh: '📍 MiaCasa河内' },
'about-maps-hanoi-desc': { en: '92 Ngh. 51 Ng. Linh Quang, Văn Chương, Văn Miếu – Quốc Tử Giám, Hà Nội', vn: '92 Ngõ 51 Ng. Linh Quang, Văn Chương, Văn Miếu – Quốc Tử Giám, Hà Nội', zh: '92 Ngh. 51 Ng. Linh Quang, Văn Chương, Văn Miếu – Quốc Tử Giám, 河内' },
'about-maps-hanoi-link': { en: 'View on Google Maps →', vn: 'Xem trên Google Maps →', zh: '在Google地图上查看 →' },
'about-maps-oq-title': { en: '📍 MiaCasa Old Quarter', vn: '📍 MiaCasa Phố Cổ', zh: '📍 MiaCasa三十六行街' },
'about-maps-oq-desc': { en: '38 P. Lương Ngọc Quyến, Hàng Buồm, Hoàn Kiếm, Hà Nội', vn: '38 P. Lương Ngọc Quyến, Hàng Buồm, Hoàn Kiếm, Hà Nội', zh: '38 P. Lương Ngọc Quyến, Hàng Buồm, Hoàn Kiếm, 河内' },
'about-maps-oq-link': { en: 'View on Google Maps →', vn: 'Xem trên Google Maps →', zh: '在Google地图上查看 →' },
// Welcome
